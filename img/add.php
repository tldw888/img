...
elseif(isset($_POST['add'])){    
    ...
    $product_img_path = "/can302-booksea/media/".time().".".end($exts);
    $temp_name = $_FILES['product_img']['tmp_name'];
    $store_path = $_SERVER['DOCUMENT_ROOT'].$product_img_path;
    move_uploaded_file($temp_name, $store_path);
    
    $insert_product = "insert into product (cat_id, name, description, supplier_id, image_path, price, inventory) values ('$product_cat_id','$product_name', '$product_description', '$product_supplier', '$product_img_path', '$product_price', '$product_inventory')";    
    echo $insert_product;
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-body"><!-- panel-body Begin -->   
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->           
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      <label class="col-md-3 control-label"> Product Inventory </label> 
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          <input name="product_inventory" type="text" class="form-control" required>
                      </div><!-- col-md-6 Finish -->
                   </div><!-- form-group Finish -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->    
                          <select name="product_supplier" class="form-control"><!-- form-control Begin -->
                              <option> Select a supplier </option>
                              <?php 
                                $get_p_supplier = "select * from supplier";
                                $run_p_supplier = mysqli_query($con,$get_p_supplier);
                                while ($row_p_supplier=mysqli_fetch_array($run_p_supplier)){
                                    $p_supplier_id = $row_p_supplier['id'];
                                    $p_supplier_name = $row_p_supplier['name'];
                                    echo "<option value='$p_supplier_id'> $p_supplier_name </option>";
                              }
                              ?>
                          </select><!-- form-control Finish -->                          
                      </div><!-- col-md-6 Finish -->
